...
function draw() {
    ...
    ctx.fillStyle = '#FE54AE'; //estilo de fundo
   ...
   // Loop para desenhar cada segmento da cobra
    ...
    if (i === 0) {
        ctx.fillStyle = '#CE238F'; // Cabeça
    } else {
        ctx.fillStyle = '#FE9EDB'; // Resto do corpo
    }
    ...
    ctx.strokeStyle = '#FF71CB'; //strokeStyle = estilo de borda
